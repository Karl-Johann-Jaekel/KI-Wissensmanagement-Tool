...
| Tag 2 — Chat, Zitate, UI | erledigt: Hybrid Retrieval + RRF, Chat mit Zitat-Validierung, 3-Spalten-UI (mobil als Tabs, Hell/Dunkel), Zitat-Viewer, Quellenfilter, Notizen. 81 Backend-Tests; Browser-E2E des gesamten Core-Loops ohne Console-Fehler (mit Mock-LLM). Offen: Durchlauf mit echtem Mistral (Kontingent), README-Screenshots mit echten Antworten |
