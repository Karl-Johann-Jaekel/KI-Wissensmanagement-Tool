...
- [x] Tests grün (`pytest`, 155; im CI 154 + 1 übersprungen, weil `test_embed` das vorgeladene Modell braucht), Frontend-Build und `oxlint` ohne Befund, Browser-E2E über 23 Schritte
